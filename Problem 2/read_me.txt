...
Core classes are in /engine.
	- dbConnect.php is a basic class to easy database connection.  It will need 
	to be updated with a valid user/pass combination which will have access to 
	the database created by the MySQL build script above.
...
/index.php is an extremely basic, self-referencing game demonstration that 
excercises the methods found in class WhirledPeas.
